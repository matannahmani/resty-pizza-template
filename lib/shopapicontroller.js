...
const switchdelivery = async (props) => 
    await axios.post(`${process.env.API_URL}/shop/${process.env.SHOP_ID}/switchdelivery`)
      .then((response) =>{
          return {
              code: 200,
              data: response
...
const switchshop = async (props) => 
    await axios.post(`${process.env.API_URL}/shop/${process.env.SHOP_ID}/switchshop`)
      .then((response) =>{
          return {
              code: 200,
              data: response
...
const switchtakeaway = async (props) => 
    await axios.post(`${process.env.API_URL}/shop/${process.env.SHOP_ID}/switchtakeaway`)
      .then((response) =>{
          return {
              code: 200,
              data: response
  ...
  const shopstatus = async() =>{
      return axios.get(`${process.env.API_URL}/shop/${process.env.SHOP_ID}/shop`).then(response => {
        return response
      });
  }
